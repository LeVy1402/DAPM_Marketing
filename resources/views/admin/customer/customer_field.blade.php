            ...
            <div class="container card-body">
                <div class="row align-items-center">
                    <div class="col-md-auto">
                        <h4 class="box-title mb-2">Lĩnh vực</h4>
                    </div>
                    <div class="col-8">
                    ...
                    <div class="col-sm-12 mb-2">
                        <table id="tableAll" class="table table-striped dataTable" style="width: 100%;" role="grid" aria-describedby="tableAll_info">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" aria-controls="tableAll" aria-label="Tên danh mục : activate to sort column ascending">Tên lĩnh vực
                                </th>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>Lĩnh vực</strong></h5>
