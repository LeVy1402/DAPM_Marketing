                    ...
                    <div class="col-sm-12 mb-2">
                        <table id="tableAll" class="table table-striped dataTable" style="width: 100%;" role="grid" aria-describedby="tableAll_info">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting" aria-controls="tableAll" aria-label="Tên danh mục : activate to sort column ascending">Tên danh mục
                                </th>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><strong>Danh mục sản phẩm</strong></h5>
